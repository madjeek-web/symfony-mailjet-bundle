...
use Madjeek\MailjetBundle\Service\MailjetEmailSender;
...
final class MailjetExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        // =====================================================================
        $webhookControllerDefinition = new Definition(\Madjeek\MailjetBundle\Webhook\WebhookController::class);
        ...
        $container->setDefinition(
            \Madjeek\MailjetBundle\Webhook\WebhookController::class,
